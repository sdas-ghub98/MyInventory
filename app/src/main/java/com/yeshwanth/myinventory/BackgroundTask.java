...
public class BackgroundTask extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        String reg_url = "http://172.19.20.65/my_inventory/register.php";
        String login_url = "http://172.19.20.65/my_inventory/login.php";
        String item_fetch_url = "http://172.19.20.65/my_inventory/item_fetch.php";
        String item_order_url = "http://172.19.20.65/my_inventory/item_order.php";
    ...
    protected void onPostExecute(String result) {
        if(result.equals("Registered Successfully...!")){
            ...
            Toast.makeText(ctx, "List Updating", Toast.LENGTH_SHORT).show();
            try {
